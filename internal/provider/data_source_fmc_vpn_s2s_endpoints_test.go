...
func TestAccDataSourceFmcVPNS2SEndpoints(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.is_extranet", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.extranet_ip_address", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.extranet_is_dynamic_ip", ""))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.send_tunnel_interface_ip_to_peer", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.acl_id", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.enable_nat_traversal", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.inside_interface_id", "76d24097-41c4-4558-a4d0-a8c07ac08470"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.enable_reverse_route_injection", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.override_remote_vpn_filter", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_endpoints.test", "items.my_ftd_01.remote_vpn_filter_acl_id", "76d24097-41c4-4558-a4d0-a8c07ac08470"))
...
func testAccDataSourceFmcVPNS2SEndpointsConfig() string {
	...
	config += `		is_extranet = false` + "\n"
	config += `		extranet_ip_address = ""` + "\n"
	config += `		extranet_is_dynamic_ip = ` + "\n"
	...
	config += `		send_tunnel_interface_ip_to_peer = false` + "\n"
	config += `		protected_networks = [{` + "\n"
	config += `			id = TBD` + "\n"
	config += `		}]` + "\n"
	config += `		acl_id = ""` + "\n"
	config += `		enable_nat_traversal = false` + "\n"
	config += `		enable_nat_exemption = false` + "\n"
	config += `		inside_interface_id = "76d24097-41c4-4558-a4d0-a8c07ac08470"` + "\n"
	...
	config += `		override_remote_vpn_filter = false` + "\n"
	config += `		remote_vpn_filter_acl_id = "76d24097-41c4-4558-a4d0-a8c07ac08470"` + "\n"
