...
func (data ExtendedCommunityList) toBody(ctx context.Context, state ExtendedCommunityList) string {
	body := ""
...
func (data *ExtendedCommunityList) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("entries"); value.Exists() {
		data.Entries = make([]ExtendedCommunityListEntries, 0, len(value.Array()))
...
func (data *ExtendedCommunityList) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ExtendedCommunityList) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data ExtendedCommunityList) adjustBody(ctx context.Context, req string) string {
