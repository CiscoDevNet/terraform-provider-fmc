	...
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"url": schema.StringAttribute{
				MarkdownDescription: "URL of the Cisco FMC/cdFMC instance or SCC Firewall Manager Base URI . This can also be set as the FMC_URL environment variable.",
				Optional:            true,
			},
...
func (p *FmcProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewDeviceHAPairPhysicalInterfaceMACAddressResource,
...
func (p *FmcProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewDeviceHAPairPhysicalInterfaceMACAddressDataSource,
