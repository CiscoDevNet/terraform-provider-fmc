...
func (data DeviceVirtualTunnelInterface) toBody(ctx context.Context, state DeviceVirtualTunnelInterface) string {
	body := ""
...
func (data *DeviceVirtualTunnelInterface) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *DeviceVirtualTunnelInterface) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *DeviceVirtualTunnelInterface) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
