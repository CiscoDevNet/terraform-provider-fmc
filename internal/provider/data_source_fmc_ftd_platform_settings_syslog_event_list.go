...
var (
	_ datasource.DataSource              = &FTDPlatformSettingsSyslogEventListDataSource{}
	_ datasource.DataSourceWithConfigure = &FTDPlatformSettingsSyslogEventListDataSource{}
)

func NewFTDPlatformSettingsSyslogEventListDataSource() datasource.DataSource {
	return &FTDPlatformSettingsSyslogEventListDataSource{}
}

type FTDPlatformSettingsSyslogEventListDataSource struct {
	client *fmc.Client
}

func (d *FTDPlatformSettingsSyslogEventListDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"type": schema.StringAttribute{
				MarkdownDescription: "Type of the object; this value is always 'EventList'.",
				Computed:            true,
			},
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the event list.",
				Computed:            true,
			},
			"event_classes": schema.ListNestedAttribute{
				MarkdownDescription: "List of event classes.",
				Computed:            true,
...
func (d *FTDPlatformSettingsSyslogEventListDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *FTDPlatformSettingsSyslogEventListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if d.client.FMCVersionParsed.LessThan(minFMCVersionFTDPlatformSettingsSyslogEventList) {
