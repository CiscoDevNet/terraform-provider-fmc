...
var minFMCVersionBulkCreateGeolocations = version.Must(version.NewVersion("999"))
var minFMCVersionBulkDeleteGeolocations = version.Must(version.NewVersion("999"))
...
func (data Geolocations) toBody(ctx context.Context, state Geolocations) string {
	body := ""
...
func (data *Geolocations) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *Geolocations) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *Geolocations) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
