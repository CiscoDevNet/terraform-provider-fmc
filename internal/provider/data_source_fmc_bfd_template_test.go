...
func TestAccDataSourceFmcBFDTemplate(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_bfd_template.test", "interval_type", "MILLISECONDS"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_bfd_template.test", "multiplier", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_bfd_template.test", "minimum_transmit", "300"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_bfd_template.test", "minimum_receive", "300"))
