...
var minFMCVersionBulkDeleteICMPv4s = version.Must(version.NewVersion("7.4"))
...
func (data ICMPv4s) toBody(ctx context.Context, state ICMPv4s) string {
	body := ""
...
func (data *ICMPv4s) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv4s) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv4s) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
