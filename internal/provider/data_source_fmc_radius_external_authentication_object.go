	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the RADIUS External Authentication object.",
				Optional:            true,
				Computed:            true,
			},
			"type": schema.StringAttribute{
				MarkdownDescription: "Type of the object; this value is always 'RADIUSConfigObject'.",
				Computed:            true,
			},
			...
			"timeout": schema.Int64Attribute{
				MarkdownDescription: "Timeout (in seconds) before retrying the primary server.",
				Computed:            true,
			},
			"retries": schema.Int64Attribute{
				MarkdownDescription: "Number of retries before rolling over to the backup RADIUS server.",
				Computed:            true,
			},
