...
type RangeOverrides struct {
	...
	Overrides  []RangeOverridesOverrides `tfsdk:"overrides"`
}
...
func (data RangeOverrides) getPath() string {
...
func (data RangeOverrides) toBody(ctx context.Context, state RangeOverrides) string {
	body := ""
...
func (data *RangeOverrides) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("dummy_overrides"); value.Exists() {
		data.Overrides = make([]RangeOverridesOverrides, 0)
...
func (data *RangeOverrides) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *RangeOverrides) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
}
...
func (data RangeOverrides) toBodyOverrides(ctx context.Context, state RangeOverrides) string {
...
func (data RangeOverrides) synthesizeOverrides(ctx context.Context, res gjson.Result) gjson.Result {
	body := ""
