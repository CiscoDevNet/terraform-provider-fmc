...
type Realms struct {
	...
	Items  map[string]RealmsItems `tfsdk:"items"`
}

type RealmsItems struct {
	Id   types.String `tfsdk:"id"`
...
func (data Realms) getPath() string {
...
func (data *Realms) fromBody(ctx context.Context, res gjson.Result) {
