...
func (data SNMPAlert) toBody(ctx context.Context, state SNMPAlert) string {
	body := ""
...
func (data *SNMPAlert) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SNMPAlert) fromBodyPartial(ctx context.Context, res gjson.Result) {
