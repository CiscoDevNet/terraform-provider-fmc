...
func TestAccDataSourceFmcSingleSignOnServer(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_single_sign_on_server.test", "base_url", "https://vpn.example.com/callback"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_single_sign_on_server.test", "identity_provider_certificate_id", "123e4567-e89b-12d3-a456-426614174000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_single_sign_on_server.test", "service_provider_certificate_id", "123e4567-e89b-12d3-a456-426614174001"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_single_sign_on_server.test", "request_signature_type", "RSA_SHA256"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceFmcSingleSignOnServerConfig(),
				Check:  resource.ComposeTestCheckFunc(checks...),
			},
			{
				Config: testAccNamedDataSourceFmcSingleSignOnServerConfig(),
				Check:  resource.ComposeTestCheckFunc(checks...),
			},
		},
	})
