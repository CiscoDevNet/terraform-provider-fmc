...
type ApplicationTypes struct {
	...
	Items  map[string]ApplicationTypesItems `tfsdk:"items"`
}

type ApplicationTypesItems struct {
	Id   types.String `tfsdk:"id"`
...
func (data ApplicationTypes) getPath() string {
...
func (data ApplicationTypes) toBody(ctx context.Context, state ApplicationTypes) string {
	body := ""
...
func (data *ApplicationTypes) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationTypes) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationTypes) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationTypes) Clone() ApplicationTypes {
	ret := *data
...
func (data ApplicationTypes) toBodyNonBulk(ctx context.Context, state ApplicationTypes) string {
