...
type RealmUserGroups struct {
	Id      types.String                    `tfsdk:"id"`
	Domain  types.String                    `tfsdk:"domain"`
	RealmId types.String                    `tfsdk:"realm_id"`
	Items   map[string]RealmUserGroupsItems `tfsdk:"items"`
}

type RealmUserGroupsItems struct {
	Id   types.String `tfsdk:"id"`
...
func (data RealmUserGroups) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/object/realmusergroups"
}
...
func (data *RealmUserGroups) fromBody(ctx context.Context, res gjson.Result) {
	if value := res.Get("realm_id"); value.Exists() {
