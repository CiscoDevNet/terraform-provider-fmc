...
var minFMCVersionBulkCreateIKEv1IPsecProposals = version.Must(version.NewVersion("999"))
var minFMCVersionBulkDeleteIKEv1IPsecProposals = version.Must(version.NewVersion("999"))
...
func (data IKEv1IPsecProposals) toBody(ctx context.Context, state IKEv1IPsecProposals) string {
	body := ""
...
func (data *IKEv1IPsecProposals) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *IKEv1IPsecProposals) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *IKEv1IPsecProposals) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
