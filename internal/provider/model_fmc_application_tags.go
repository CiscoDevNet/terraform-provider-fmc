...
type ApplicationTags struct {
	...
	Items  map[string]ApplicationTagsItems `tfsdk:"items"`
}

type ApplicationTagsItems struct {
	Id   types.String `tfsdk:"id"`
...
func (data ApplicationTags) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/object/applicationtags"
}
...
func (data ApplicationTags) toBody(ctx context.Context, state ApplicationTags) string {
	body := ""
...
func (data *ApplicationTags) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationTags) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationTags) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationTags) Clone() ApplicationTags {
	ret := *data
...
func (data ApplicationTags) toBodyNonBulk(ctx context.Context, state ApplicationTags) string {
