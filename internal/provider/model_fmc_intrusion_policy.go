...
func (data IntrusionPolicy) toBody(ctx context.Context, state IntrusionPolicy) string {
	body := ""
...
func (data *IntrusionPolicy) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *IntrusionPolicy) fromBodyPartial(ctx context.Context, res gjson.Result) {
