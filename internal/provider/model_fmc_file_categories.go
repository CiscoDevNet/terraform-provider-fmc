...
type FileCategories struct {
	...
	Items  map[string]FileCategoriesItems `tfsdk:"items"`
}

type FileCategoriesItems struct {
	Id   types.String `tfsdk:"id"`
...
var minFMCVersionFileCategories = version.Must(version.NewVersion("7.4"))

// End of section. //template:end minimumVersions

// Section below is generated&owned by "gen/generator.go". //template:begin getPath

func (data FileCategories) getPath() string {
...
func (data FileCategories) toBody(ctx context.Context, state FileCategories) string {
	body := ""
...
func (data *FileCategories) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *FileCategories) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *FileCategories) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *FileCategories) Clone() FileCategories {
	ret := *data
