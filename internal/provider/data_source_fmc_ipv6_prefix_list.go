...
func (d *IPv6PrefixListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the IPv6 Prefix List.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the IPv6 Prefix List object.",
				Optional:            true,
				Computed:            true,
			},
...
func (d *IPv6PrefixListDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
