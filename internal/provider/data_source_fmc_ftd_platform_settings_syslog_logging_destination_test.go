...
func TestAccDataSourceFmcFTDPlatformSettingsSyslogLoggingDestination(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceFmcFTDPlatformSettingsSyslogLoggingDestinationPrerequisitesConfig + testAccDataSourceFmcFTDPlatformSettingsSyslogLoggingDestinationConfig(),
...
func testAccDataSourceFmcFTDPlatformSettingsSyslogLoggingDestinationConfig() string {
	...
	config += `
		data "fmc_ftd_platform_settings_syslog_logging_destination" "test" {
			id = fmc_ftd_platform_settings_syslog_logging_destination.test.id
