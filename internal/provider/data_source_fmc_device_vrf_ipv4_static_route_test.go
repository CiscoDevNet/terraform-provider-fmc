...
func TestAccDataSourceFmcDeviceVRFIPv4StaticRoute(t *testing.T) {
...
const testAccDataSourceFmcDeviceVRFIPv4StaticRoutePrerequisitesConfig = `
...
func testAccDataSourceFmcDeviceVRFIPv4StaticRouteConfig() string {
	...
	config += `
		data "fmc_device_vrf_ipv4_static_route" "test" {
			id = fmc_device_vrf_ipv4_static_route.test.id
