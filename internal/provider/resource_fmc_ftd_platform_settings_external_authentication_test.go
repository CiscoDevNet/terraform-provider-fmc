...
func TestAccFmcFTDPlatformSettingsExternalAuthentication(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttrSet("fmc_ftd_platform_settings_external_authentication.test", "type"))

	var steps []resource.TestStep
	steps = append(steps, resource.TestStep{
		Config: testAccFmcFTDPlatformSettingsExternalAuthenticationPrerequisitesConfig + testAccFmcFTDPlatformSettingsExternalAuthenticationConfig_all(),
...
const testAccFmcFTDPlatformSettingsExternalAuthenticationPrerequisitesConfig = `
