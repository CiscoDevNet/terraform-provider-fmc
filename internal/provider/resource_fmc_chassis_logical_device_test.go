...
func TestAccFmcChassisLogicalDevice(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_chassis_logical_device.test", "permit_expert_mode", ""))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_chassis_logical_device.test", "access_policy_id", "76d24097-41c4-4558-a4d0-a8c07ac08470"))
