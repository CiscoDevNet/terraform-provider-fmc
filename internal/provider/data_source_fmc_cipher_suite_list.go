...
var (
	_ datasource.DataSource              = &CipherSuiteListDataSource{}
	_ datasource.DataSourceWithConfigure = &CipherSuiteListDataSource{}
)

func NewCipherSuiteListDataSource() datasource.DataSource {
	return &CipherSuiteListDataSource{}
}

type CipherSuiteListDataSource struct {
	client *fmc.Client
}

func (d *CipherSuiteListDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the Cipher Suite List object.",
				Optional:            true,
				Computed:            true,
			},
...
func (d *CipherSuiteListDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *CipherSuiteListDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
