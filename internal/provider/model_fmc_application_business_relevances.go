...
func (data ApplicationBusinessRelevances) toBody(ctx context.Context, state ApplicationBusinessRelevances) string {
	body := ""
...
func (data *ApplicationBusinessRelevances) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationBusinessRelevances) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationBusinessRelevances) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *ApplicationBusinessRelevances) Clone() ApplicationBusinessRelevances {
	ret := *data
...
func (data ApplicationBusinessRelevances) toBodyNonBulk(ctx context.Context, state ApplicationBusinessRelevances) string {
