...
var minFMCVersionCreateResourceProfile = version.Must(version.NewVersion("7.4"))
...
func (data ResourceProfile) toBody(ctx context.Context, state ResourceProfile) string {
	body := ""
...
func (data *ResourceProfile) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ResourceProfile) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ResourceProfile) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
