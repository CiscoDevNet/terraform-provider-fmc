...
func (data FTDPlatformSettingsTimeSynchronization) toBody(ctx context.Context, state FTDPlatformSettingsTimeSynchronization) string {
	body := ""
	...
	if !data.NtpServers.IsNull() {
		...
		body, _ = sjson.Set(body, "ntpServerInfos", values)
	}
	return body
}
...
func (data *FTDPlatformSettingsTimeSynchronization) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *FTDPlatformSettingsTimeSynchronization) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *FTDPlatformSettingsTimeSynchronization) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data FTDPlatformSettingsTimeSynchronization) toBodyPutDelete(ctx context.Context) string {
	body := ""
	if data.Id.ValueString() != "" {
		body, _ = sjson.Set(body, "id", data.Id.ValueString())
	}
	...
	body, _ = sjson.Set(body, "ntpMode", "SYNC_VIA_MGMT_CENTER_NTP")
	return body
}
