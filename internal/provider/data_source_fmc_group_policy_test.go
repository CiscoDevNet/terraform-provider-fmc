...
func TestAccDataSourceFmcGroupPolicy(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "enable_ssl_protocol", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "enable_ipsec_ikev2_protocol", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "primary_dns_server", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "secondary_dns_server", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "primary_wins_server", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "secondary_wins_server", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "dhcp_scope_network_id", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "default_domain", ""))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "split_d_n_s_request_policy", "TUNNEL_ALL"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "split_d_n_s_domain_list", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "secure_client_client_profile_id", "12345678-1234-1234-1234-123456"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "enable_keep_alive_messages", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "keep_alive_message_interval", "20"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "enable_gateway_dpd", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "gateway_dpd_interval", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "enable_client_dpd", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "client_dpd_interval", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "client_bypass_protocol", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "enable_ssl_rekey", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "rekey_method", "NEW_TUNNEL"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "rekey_interval", "60"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "client_firewall_private_network_rules_id", "12345678-1234-1234-1234-123456"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "client_firewall_public_network_rules_id", "12345678-1234-1234-1234-123456"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "custom_attributes.0.id", "12345678-1234-1234-1234-123456"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "custom_attributes.0.type", "myAnyConnectAttribute"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "restrict_vpn_to_vlan_id", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "access_hours_id", "12345678-1234-1234-1234-123456"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "simultaneous_login_per_user", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "max_connection_time", "3600"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "max_connection_time_alert_interval", "1"))
