...
func TestAccDataSourceFmcGroupPolicy(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "gateway_dpd", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "gateway_dpd_interval", "30"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_group_policy.test", "client_dpd", "true"))
