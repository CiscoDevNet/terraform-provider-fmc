...
type URLCategories struct {
	...
	Items  map[string]URLCategoriesItems `tfsdk:"items"`
}

type URLCategoriesItems struct {
	Id   types.String `tfsdk:"id"`
...
func (data URLCategories) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/object/urlcategories"
}
...
func (data *URLCategories) fromBody(ctx context.Context, res gjson.Result) {
