...
func (data DeviceVRFIPv4StaticRoute) getPath() string {
...
func (data DeviceVRFIPv4StaticRoute) toBody(ctx context.Context, state DeviceVRFIPv4StaticRoute) string {
	body := ""
...
func (data *DeviceVRFIPv4StaticRoute) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("selectedNetworks"); value.Exists() {
		...
		value.ForEach(func(k, res gjson.Result) bool {
			parent := &data
			data := DeviceVRFIPv4StaticRouteDestinationNetworks{}
...
func (data *DeviceVRFIPv4StaticRoute) fromBodyPartial(ctx context.Context, res gjson.Result) {
