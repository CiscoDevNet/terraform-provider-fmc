...
func (d *CountriesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the Countries.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.MapNestedAttribute{
				MarkdownDescription: "Map of Countries. The key of the map is the name of the individual Country.",
				Optional:            true,
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							MarkdownDescription: "Id of the Country object.",
							Computed:            true,
						},
						"type": schema.StringAttribute{
							MarkdownDescription: "Type of the object; this value is always 'Country'.",
							Computed:            true,
						},
						"iso2": schema.StringAttribute{
							MarkdownDescription: "ISO2 country code.",
							Computed:            true,
						},
						"iso3": schema.StringAttribute{
							MarkdownDescription: "ISO3 country code.",
							Computed:            true,
						},
					},
				},
...
func (d *CountriesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
