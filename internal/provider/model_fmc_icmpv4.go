...
func (data ICMPv4) getPath() string {
...
func (data ICMPv4) toBody(ctx context.Context, state ICMPv4) string {
	body := ""
...
func (data *ICMPv4) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv4) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv4) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
