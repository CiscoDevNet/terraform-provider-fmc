...
func (data ISESGTs) toBody(ctx context.Context, state ISESGTs) string {
	body := ""
...
func (data *ISESGTs) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ISESGTs) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ISESGTs) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *ISESGTs) Clone() ISESGTs {
	ret := *data
...
func (data ISESGTs) toBodyNonBulk(ctx context.Context, state ISESGTs) string {
