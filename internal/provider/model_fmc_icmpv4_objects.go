...
func (data ICMPv4Objects) getPath() string {
...
func (data ICMPv4Objects) toBody(ctx context.Context, state ICMPv4Objects) string {
	body := ""
...
func (data *ICMPv4Objects) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv4Objects) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv4Objects) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
