...
func (d *ICMPv4ObjectDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the ICMPv4 Object.").AddAttributeDescription("This object is deprecated. Please use `fmc_icmpv4` instead.").String,
