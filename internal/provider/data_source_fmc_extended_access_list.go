...
var (
	_ datasource.DataSource              = &ExtendedAccessListDataSource{}
	_ datasource.DataSourceWithConfigure = &ExtendedAccessListDataSource{}
)

func NewExtendedAccessListDataSource() datasource.DataSource {
	return &ExtendedAccessListDataSource{}
}

type ExtendedAccessListDataSource struct {
	client *fmc.Client
}

func (d *ExtendedAccessListDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_extended_access_list"
}

func (d *ExtendedAccessListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the Extended Access List.").String,
...
func (d *ExtendedAccessListDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *ExtendedAccessListDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *ExtendedAccessListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
