...
func TestAccDataSourceFmcDeviceOSPF(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "administrative_distance_inter_area", "110"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "administrative_distance_intra_area", "110"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "administrative_distance_external", "110"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "timer_lsa_group", "240"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "default_route_always_advertise", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "default_route_metric", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "default_route_metric_type", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "default_route_route_map_id", "76d24097-41c4-4558-a4d0-a8c07ac08470"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.id", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.type", "normal"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.networks.0.id", "123e4567-e89b-12d3-a456-426614174000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.networks.0.name", "Office Network"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.authentication", "MESSAGE_DIGEST"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.default_cost", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.ranges.0.network_object_id", "123e4567-e89b-12d3-a456-426614174000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.ranges.0.advertise", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.virtual_links.0.peer_router_host_id", "123e4567-e89b-12d3-a456-426614174000"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.virtual_links.0.hello_interval", "10"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "areas.0.virtual_links.0.transmit_delay", "1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.ospf_match_external_1", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.ospf_match_external_2", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.ospf_match_internal", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.ospf_match_nssa_external_1", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.ospf_match_nssa_external_2", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.process_id", "2"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.subnets", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.metric", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.metric_type", "TYPE_2"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.tag", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ospf.test", "redistributions.0.route_map_id", "76d24097-41c4-4558-a4d0-a8c07ac08470"))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceFmcDeviceOSPFConfig(),
...
func testAccDataSourceFmcDeviceOSPFConfig() string {
	...
	config += `
		data "fmc_device_ospf" "test" {
			id = fmc_device_ospf.test.id
