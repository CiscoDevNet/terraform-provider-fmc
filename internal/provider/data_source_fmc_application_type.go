...
var (
	_ datasource.DataSource              = &ApplicationTypeDataSource{}
	_ datasource.DataSourceWithConfigure = &ApplicationTypeDataSource{}
)
...
func (d *ApplicationTypeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the Application Type.").String,
...
func (d *ApplicationTypeDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
