...
func TestAccFmcFTDPlatformSettingsSyslogSettings(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttrSet("fmc_ftd_platform_settings_syslog_settings.test", "type"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_syslog_settings.test", "facility", "LOCAL4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_syslog_settings.test", "device_id_type", "USERDEFINEDID"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_syslog_settings.test", "device_id_user_defined_id", "my_device_id"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_syslog_settings.test", "device_id_interface_id", "123e4567-e89b-12d3-a456-426614174000"))
...
const testAccFmcFTDPlatformSettingsSyslogSettingsPrerequisitesConfig = `
...
func testAccFmcFTDPlatformSettingsSyslogSettingsConfig_all() string {
