...
var (
	_ datasource.DataSource              = &FTDPlatformSettingsSyslogLoggingDestinationDataSource{}
	_ datasource.DataSourceWithConfigure = &FTDPlatformSettingsSyslogLoggingDestinationDataSource{}
)

func NewFTDPlatformSettingsSyslogLoggingDestinationDataSource() datasource.DataSource {
	return &FTDPlatformSettingsSyslogLoggingDestinationDataSource{}
}

type FTDPlatformSettingsSyslogLoggingDestinationDataSource struct {
	client *fmc.Client
}

func (d *FTDPlatformSettingsSyslogLoggingDestinationDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"type": schema.StringAttribute{
				MarkdownDescription: "Type of the object; this value is always 'LoggingDestination'.",
				Computed:            true,
			},
			...
			"event_class_filters": schema.ListNestedAttribute{
				MarkdownDescription: "Filters per event class.",
				Computed:            true,
...
func (d *FTDPlatformSettingsSyslogLoggingDestinationDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *FTDPlatformSettingsSyslogLoggingDestinationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if d.client.FMCVersionParsed.LessThan(minFMCVersionFTDPlatformSettingsSyslogLoggingDestination) {
