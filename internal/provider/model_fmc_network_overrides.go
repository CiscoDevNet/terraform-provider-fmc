...
type NetworkOverrides struct {
	...
	Overrides  []NetworkOverridesOverrides `tfsdk:"overrides"`
}
...
func (data NetworkOverrides) getPath() string {
...
func (data NetworkOverrides) toBody(ctx context.Context, state NetworkOverrides) string {
	body := ""
...
func (data *NetworkOverrides) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("dummy_overrides"); value.Exists() {
		data.Overrides = make([]NetworkOverridesOverrides, 0, int(value.Get("#").Int()))
...
func (data *NetworkOverrides) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *NetworkOverrides) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
}
...
func (data NetworkOverrides) toBodyOverrides(ctx context.Context, state NetworkOverrides) string {
...
func (data NetworkOverrides) synthesizeOverrides(ctx context.Context, res gjson.Result) gjson.Result {
	body := ""
