...
func (data SecurityIntelligenceNetworkFeeds) toBody(ctx context.Context, state SecurityIntelligenceNetworkFeeds) string {
	body := ""
...
func (data *SecurityIntelligenceNetworkFeeds) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SecurityIntelligenceNetworkFeeds) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *SecurityIntelligenceNetworkFeeds) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
