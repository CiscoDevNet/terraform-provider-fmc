...
func TestAccDataSourceFmcVPNS2SAdvancedSettings(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "cert_use_certificate_map_configured_in_endpoint_to_determine_tunnel", "false"))
