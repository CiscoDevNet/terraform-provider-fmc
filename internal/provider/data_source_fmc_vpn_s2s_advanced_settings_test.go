...
func TestAccDataSourceFmcVPNS2SAdvancedSettings(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "ike_keepalive_threshold", "15"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "ike_keepalive_retry_interval", "5"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "ike_peer_identity_validation", "DO_NOT_CHECK"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "ike_aggressive_mode", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "ike_notification_on_tunnel_disconnect", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "ikev2_threshold_to_challenge_incoming_cookies", "55"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "vpn_idle_timeout", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "vpn_idle_timeout_value", "25"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "cert_use_map_configured_in_endpoint_to_determine_tunnel", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "cert_use_ou_to_determine_tunnel", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "cert_use_ike_identity_to_determine_tunnel", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_vpn_s2s_advanced_settings.test", "cert_use_peer_ip_address_to_determine_tunnel", "false"))
...
const testAccDataSourceFmcVPNS2SAdvancedSettingsPrerequisitesConfig = `
