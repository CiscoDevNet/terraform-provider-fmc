...
var minFMCVersionBulkCreateIPv6AddressPools = version.Must(version.NewVersion("999"))
var minFMCVersionBulkDeleteIPv6AddressPools = version.Must(version.NewVersion("999"))
...
func (data IPv6AddressPools) toBody(ctx context.Context, state IPv6AddressPools) string {
	body := ""
...
func (data *IPv6AddressPools) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *IPv6AddressPools) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *IPv6AddressPools) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
