...
func (data Range) toBody(ctx context.Context, state Range) string {
	body := ""
...
func (data *Range) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *Range) fromBodyPartial(ctx context.Context, res gjson.Result) {
