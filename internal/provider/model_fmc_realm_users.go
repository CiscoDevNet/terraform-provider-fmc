...
type RealmUsers struct {
	...
	Items   map[string]RealmUsersItems `tfsdk:"items"`
}

type RealmUsersItems struct {
	Id   types.String `tfsdk:"id"`
...
func (data RealmUsers) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/object/realmusers"
}
...
func (data *RealmUsers) fromBody(ctx context.Context, res gjson.Result) {
