...
func TestAccDataSourceFmcDeviceVTIInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_vti_interface.test", "tunnel_type", "STATIC"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_vti_interface.test", "ipv4_static_address", "10.10.10.10"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_vti_interface.test", "ipv4_static_netmask", "24"))
