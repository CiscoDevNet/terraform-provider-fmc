...
func TestAccDataSourceFmcDeviceVTIInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_vti_interface.test", "ipsec_tunnel_mode", "ipv4"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_vti_interface.test", "ip_based_monitoring_next_hop", "10.10.10.100"))
