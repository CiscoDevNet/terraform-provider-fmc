...
var minFMCVersionCreateStandardAccessList = version.Must(version.NewVersion("7.2"))
...
func (data StandardAccessList) toBody(ctx context.Context, state StandardAccessList) string {
	body := ""
...
func (data *StandardAccessList) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *StandardAccessList) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *StandardAccessList) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
