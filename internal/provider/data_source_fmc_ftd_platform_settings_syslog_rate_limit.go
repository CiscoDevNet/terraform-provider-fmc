...
func (d *FTDPlatformSettingsSyslogRateLimitDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the FTD Platform Settings Syslog Rate Limit.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"rate_limit_type": schema.StringAttribute{
				MarkdownDescription: "The rate limit type.",
				Computed:            true,
			},
