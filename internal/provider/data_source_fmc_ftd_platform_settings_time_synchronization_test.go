...
func TestAccDataSourceFmcFTDPlatformSettingsTimeSynchronization(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceFmcFTDPlatformSettingsTimeSynchronizationPrerequisitesConfig + testAccDataSourceFmcFTDPlatformSettingsTimeSynchronizationConfig(),
...
const testAccDataSourceFmcFTDPlatformSettingsTimeSynchronizationPrerequisitesConfig = `
...
func testAccDataSourceFmcFTDPlatformSettingsTimeSynchronizationConfig() string {
	...
	config += `
		data "fmc_ftd_platform_settings_time_synchronization" "test" {
			id = fmc_ftd_platform_settings_time_synchronization.test.id
