...
func TestAccFmcFTDPlatformSettingsSNMP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "enable_snmp_server", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "snmp_management_hosts.0.use_management_interface", "false"))
