...
func TestAccFmcFTDPlatformSettingsSNMP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "management_hosts.0.trap", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "management_hosts.0.trap_port", "162"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "management_hosts.0.use_management_interface", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "snmpv3_users.0.authentication_algorithm", "SHA256"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "snmpv3_users.0.encryption_algorithm", "AES256"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "trap_cpu_rising", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "trap_cpu_rising_threshold", "70"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "trap_cpu_rising_interval", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "trap_memory_rising", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "trap_memory_rising_threshold", "70"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "trap_failover_state", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_snmp.test", "trap_cluster_state", "true"))
