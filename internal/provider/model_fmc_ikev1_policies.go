...
var minFMCVersionBulkCreateIKEv1Policies = version.Must(version.NewVersion("999"))
var minFMCVersionBulkDeleteIKEv1Policies = version.Must(version.NewVersion("999"))
...
func (data IKEv1Policies) toBody(ctx context.Context, state IKEv1Policies) string {
	body := ""
...
func (data *IKEv1Policies) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *IKEv1Policies) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *IKEv1Policies) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
