...
func TestAccFmcDeviceDDNS(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttrSet("fmc_device_ddns.test", "type"))

	var steps []resource.TestStep
	if os.Getenv("SKIP_MINIMUM_TEST") == "" {
		steps = append(steps, resource.TestStep{
			Config: testAccFmcDeviceDDNSPrerequisitesConfig + testAccFmcDeviceDDNSConfig_minimum(),
		})
	}
	steps = append(steps, resource.TestStep{
		Config: testAccFmcDeviceDDNSPrerequisitesConfig + testAccFmcDeviceDDNSConfig_all(),
...
const testAccFmcDeviceDDNSPrerequisitesConfig = `
...
func testAccFmcDeviceDDNSConfig_minimum() string {
...
func testAccFmcDeviceDDNSConfig_all() string {
	config := `resource "fmc_device_ddns" "test" {` + "\n"
	config += `	device_id = var.device_id` + "\n"
