...
func (d *ApplicationFilterDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the Application Filter.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "Name of the Application Filter.",
				Optional:            true,
				Computed:            true,
			},
			"type": schema.StringAttribute{
				MarkdownDescription: "Type of the object; this value is always 'ApplicationFilter'.",
				Computed:            true,
			},
			"applications": schema.SetNestedAttribute{
				MarkdownDescription: "Set of Applications. Either `applications` or `filters` must be specified.",
				Computed:            true,
			...
			"filters": schema.ListNestedAttribute{
				MarkdownDescription: "List of Application filtering conditions. Either `applications` or `filters` must be specified.",
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"risks": schema.SetNestedAttribute{
							MarkdownDescription: "Set of Application Risks.",
							Computed:            true,
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.StringAttribute{
										MarkdownDescription: "Id of the Application Risk.",
										Computed:            true,
									},
								},
							},
						...
						"business_relevances": schema.SetNestedAttribute{
							MarkdownDescription: "Set of Application Business Relevances.",
							Computed:            true,
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.StringAttribute{
										MarkdownDescription: "Id of the Application Business Relevance.",
										Computed:            true,
									},
								},
							},
...
func (d *ApplicationFilterDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *ApplicationFilterDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
