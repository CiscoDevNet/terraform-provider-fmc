...
type IKEv2IPsecProposals struct {
	Id     types.String                        `tfsdk:"id"`
	Domain types.String                        `tfsdk:"domain"`
	Items  map[string]IKEv2IPsecProposalsItems `tfsdk:"items"`
}
...
var minFMCVersionBulkCreateIKEv2IPsecProposals = version.Must(version.NewVersion("999"))
var minFMCVersionBulkDeleteIKEv2IPsecProposals = version.Must(version.NewVersion("999"))

// End of section. //template:end minimumVersions

// Section below is generated&owned by "gen/generator.go". //template:begin getPath

func (data IKEv2IPsecProposals) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/object/ikev2ipsecproposals"
}
...
func (data IKEv2IPsecProposals) toBody(ctx context.Context, state IKEv2IPsecProposals) string {
	body := ""
...
func (data *IKEv2IPsecProposals) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *IKEv2IPsecProposals) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *IKEv2IPsecProposals) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *IKEv2IPsecProposals) Clone() IKEv2IPsecProposals {
	ret := *data
...
func (data IKEv2IPsecProposals) toBodyNonBulk(ctx context.Context, state IKEv2IPsecProposals) string {
