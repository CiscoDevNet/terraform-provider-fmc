...
func (data URL) toBody(ctx context.Context, state URL) string {
	body := ""
...
func (data *URL) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *URL) fromBodyPartial(ctx context.Context, res gjson.Result) {
