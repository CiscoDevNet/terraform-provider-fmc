...
func TestAccFmcFTDPlatformSettingsSyslogSettingsSyslogID(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_syslog_settings_syslog_id.test", "syslog_id", "305011"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_ftd_platform_settings_syslog_settings_syslog_id.test", "log_level", "ERR"))
