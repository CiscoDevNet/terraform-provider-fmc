...
func TestAccDataSourceFmcRealmADLDAP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "directory_password", "my_password"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "base_dn", "dc=example,dc=com"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "group_dn", "ou=users,dc=example,dc=com"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "directory_configurations.0.hostname", "ldap.example.com"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "directory_configurations.0.port", "389"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "directory_configurations.0.encryption", "LDAPS"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "directory_configurations.0.encryption_certificate", "1234-5678-90AB-CDEF12345678"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "directory_configurations.0.use_routing_to_select_interface", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "directory_configurations.0.interface_group_id", "1234-5678-90AB-CDEF12345678"))
