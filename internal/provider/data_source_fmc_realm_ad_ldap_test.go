...
func TestAccDataSourceFmcRealmADLDAP(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "enabled", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "included_users.0", "user1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "included_groups.0", "group1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "excluded_users.0", "user2"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "excluded_groups.0", "group2"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "update_hour", "2"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "update_interval", "4"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "group_attribute", "member"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_realm_ad_ldap.test", "timeout_ise_and_passive_indentity_users", "1440"))
