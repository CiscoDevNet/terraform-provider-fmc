...
type SecureClientPosturePackage struct {
...
func (data SecureClientPosturePackage) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/object/hostscanpackages"
}
...
func (data *SecureClientPosturePackage) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SecureClientPosturePackage) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *SecureClientPosturePackage) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *SecureClientPosturePackage) toBodyMultiPartUpload(ctx context.Context) (io.Reader, string, error) {
