...
func TestAccFmcRouteMap(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_route_map.test", "entries.0.match_route_metrics.0", "100"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_route_map.test", "entries.0.match_tags.0", "110"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_route_map.test", "entries.0.set_bgp_as_path_prepend.0", "64512"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_route_map.test", "entries.0.set_bgp_community_route_target", "100:100,200:200"))
...
const testAccFmcRouteMapPrerequisitesConfig = `
