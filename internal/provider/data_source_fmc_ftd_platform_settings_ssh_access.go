...
var (
	_ datasource.DataSource              = &FTDPlatformSettingsSSHAccessDataSource{}
	_ datasource.DataSourceWithConfigure = &FTDPlatformSettingsSSHAccessDataSource{}
)

func NewFTDPlatformSettingsSSHAccessDataSource() datasource.DataSource {
	return &FTDPlatformSettingsSSHAccessDataSource{}
}

type FTDPlatformSettingsSSHAccessDataSource struct {
	client *fmc.Client
}

func (d *FTDPlatformSettingsSSHAccessDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"type": schema.StringAttribute{
				MarkdownDescription: "Type of the object; this value is always 'SSHAccessSetting'.",
				Computed:            true,
			},
			"source_network_object_id": schema.StringAttribute{
				MarkdownDescription: "Id of network object (host, network, network group) defining the source IP addresses from which SSH access is allowed.",
				Computed:            true,
			},
...
func (d *FTDPlatformSettingsSSHAccessDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *FTDPlatformSettingsSSHAccessDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if d.client.FMCVersionParsed.LessThan(minFMCVersionFTDPlatformSettingsSSHAccess) {
