...
func (data FQDNOverrides) toBody(ctx context.Context, state FQDNOverrides) string {
	body := ""
...
func (data *FQDNOverrides) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("dummy_overrides"); value.Exists() {
		data.Overrides = make([]FQDNOverridesOverrides, 0, int(value.Get("#").Int()))
...
func (data *FQDNOverrides) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *FQDNOverrides) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
}
...
func (data FQDNOverrides) toBodyOverrides(ctx context.Context, state FQDNOverrides) string {
