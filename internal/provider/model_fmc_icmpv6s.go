...
type ICMPv6s struct {
	...
	Items  map[string]ICMPv6sItems `tfsdk:"items"`
}

type ICMPv6sItems struct {
	Id          types.String `tfsdk:"id"`
...
var minFMCVersionBulkDeleteICMPv6s = version.Must(version.NewVersion("7.4"))

// End of section. //template:end minimumVersions

// Section below is generated&owned by "gen/generator.go". //template:begin getPath

func (data ICMPv6s) getPath() string {
...
func (data ICMPv6s) toBody(ctx context.Context, state ICMPv6s) string {
	body := ""
...
func (data *ICMPv6s) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv6s) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv6s) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv6s) Clone() ICMPv6s {
	ret := *data
...
func (data ICMPv6s) toBodyNonBulk(ctx context.Context, state ICMPv6s) string {
