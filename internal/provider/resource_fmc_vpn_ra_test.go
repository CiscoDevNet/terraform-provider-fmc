...
func TestAccFmcVPNRA(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_vpn_ra.test", "description", "My Remote Access VPN Configuration"))
...
const testAccFmcVPNRAPrerequisitesConfig = `
