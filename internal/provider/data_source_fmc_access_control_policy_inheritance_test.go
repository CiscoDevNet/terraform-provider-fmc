...
func TestAccDataSourceFmcAccessControlPolicyInheritance(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttrSet("data.fmc_access_control_policy_inheritance.test", "type"))
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceFmcAccessControlPolicyInheritancePrerequisitesConfig + testAccDataSourceFmcAccessControlPolicyInheritanceConfig(),
