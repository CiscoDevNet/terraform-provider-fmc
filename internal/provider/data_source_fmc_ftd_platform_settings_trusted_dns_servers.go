...
func (d *FTDPlatformSettingsTrustedDNSServersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source reads the FTD Platform Settings Trusted DNS Servers.").AddMinimumVersionHeaderDescription().AddMinimumVersionDescription("7.7").String,
...
func (d *FTDPlatformSettingsTrustedDNSServersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if d.client.FMCVersionParsed.LessThan(minFMCVersionFTDPlatformSettingsTrustedDNSServers) {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("UnsupportedVersion: FMC version %s does not support FTD Platform Settings Trusted DNS Servers, minimum required version is 7.7", d.client.FMCVersion))
		return
	}
