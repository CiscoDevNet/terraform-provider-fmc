...
func TestAccDataSourceFmcFTDPlatformSettingsSyslogLoggingSetup(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_ftd_platform_settings_syslog_logging_setup.test", "logging_enabled", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_ftd_platform_settings_syslog_logging_setup.test", "logging_on_failover_standby_unit_enabled", "false"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_ftd_platform_settings_syslog_logging_setup.test", "flash_enabled", "false"))
