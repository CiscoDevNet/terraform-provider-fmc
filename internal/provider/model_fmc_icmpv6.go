...
func (data ICMPv6) getPath() string {
...
func (data ICMPv6) toBody(ctx context.Context, state ICMPv6) string {
	body := ""
...
func (data *ICMPv6) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv6) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ICMPv6) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
