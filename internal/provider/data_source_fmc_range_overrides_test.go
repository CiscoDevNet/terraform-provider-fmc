...
const testAccDataSourceFmcRangeOverridesPrerequisitesConfig = `
...
func testAccDataSourceFmcRangeOverridesConfig() string {
	...
	config += `
		data "fmc_range_overrides" "test" {
			id = fmc_range_overrides.test.id
		}
	`
	return config
}
...
func testAccNamedDataSourceFmcRangeOverridesConfig() string {
	...
	config += `
		data "fmc_range_overrides" "test" {
			parent_name = fmc_range_overrides.test.parent_name
		}
	`
	return config
}
