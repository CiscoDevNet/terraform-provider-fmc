...
var minFMCVersionFileTypes = version.Must(version.NewVersion("7.4"))
...
func (data FileTypes) toBody(ctx context.Context, state FileTypes) string {
	body := ""
...
func (data *FileTypes) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *FileTypes) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *FileTypes) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *FileTypes) Clone() FileTypes {
	ret := *data
