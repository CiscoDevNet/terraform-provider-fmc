...
type IntrusionRuleGroups struct {
	Id     types.String                        `tfsdk:"id"`
	Domain types.String                        `tfsdk:"domain"`
	Items  map[string]IntrusionRuleGroupsItems `tfsdk:"items"`
}

type IntrusionRuleGroupsItems struct {
	Id          types.String `tfsdk:"id"`
...
var minFMCVersionBulkDeleteIntrusionRuleGroups = version.Must(version.NewVersion("999"))

// End of section. //template:end minimumVersions

// Section below is generated&owned by "gen/generator.go". //template:begin getPath

func (data IntrusionRuleGroups) getPath() string {
...
func (data *IntrusionRuleGroups) fromBody(ctx context.Context, res gjson.Result) {
