...
func (data AccessCategory) toBody(ctx context.Context, state AccessCategory) string {
	body := ""
...
func (data *AccessCategory) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *AccessCategory) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *AccessCategory) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
