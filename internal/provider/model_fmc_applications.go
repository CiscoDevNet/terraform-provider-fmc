...
type Applications struct {
	...
	Items  map[string]ApplicationsItems `tfsdk:"items"`
}

type ApplicationsItems struct {
	Id   types.String `tfsdk:"id"`
...
func (data Applications) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/object/applications"
}
...
func (data Applications) toBody(ctx context.Context, state Applications) string {
	body := ""
...
func (data *Applications) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *Applications) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *Applications) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
...
func (data *Applications) Clone() Applications {
	ret := *data
...
func (data Applications) toBodyNonBulk(ctx context.Context, state Applications) string {
