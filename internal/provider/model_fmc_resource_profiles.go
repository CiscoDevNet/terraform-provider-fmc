...
var minFMCVersionCreateResourceProfiles = version.Must(version.NewVersion("7.4"))
var minFMCVersionBulkCreateResourceProfiles = version.Must(version.NewVersion("999"))
var minFMCVersionBulkDeleteResourceProfiles = version.Must(version.NewVersion("999"))
...
func (data ResourceProfiles) toBody(ctx context.Context, state ResourceProfiles) string {
	body := ""
...
func (data *ResourceProfiles) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *ResourceProfiles) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *ResourceProfiles) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
