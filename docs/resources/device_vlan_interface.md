...
page_title: "fmc_device_vlan_interface Resource - terraform-provider-fmc"
subcategory: "Devices"
description: |-
  This resource manages a Device VLAN Interface.
---

# fmc_device_vlan_interface (Resource)
...
- `mode` (String) Mode of the interface.
  - Choices: `NONE`
- `vlan_id` (Number) VLAN identifier, unique on the device.
  - Range: `1`-`4094`
...
- `arp_table_entries` (Attributes List) Custom IP to MAC address mapping. (see [below for nested schema](#nestedatt--arp_table_entries))
...
- `ipv4_pppoe_authentication` (String) PPPoE Configuration - PPPoE Authentication.
  - Choices: `PAP`, `CHAP`, `MSCHAP`
- `ipv4_pppoe_password` (String) PPPoE Configuration - PPPoE Password.
- `ipv4_pppoe_route_metric` (Number) PPPoE Configuration - PPPoE route metric.
  - Range: `1`-`255`
...
- `ipv6_ns_interval` (Number) Neighbor Solicitation (NS) interval.
  - Range: `1000`-`3600000`
- `ipv6_prefixes` (Attributes List) List of IPv6 prefixes. (see [below for nested schema](#nestedatt--ipv6_prefixes))
...
- `priority` (Number) Priority. Can only be set for routed interfaces.
  - Range: `0`-`65535`
- `security_zone_id` (String) Id of the assigned Security Zone. Can only be used when the interface's `logical_name` is set.
- `standby_mac_address` (String) MAC address for standby interface in format 0123.4567.89ab.

### Read-Only

- `id` (String) Id of the object
- `name` (String) Name of the VLAN interface in format `Vlan<vlan_id>` (eg. Vlan7).
- `type` (String) Type of the object, this value is always 'VlanInterface'.
...
terraform import fmc_device_vlan_interface.example "<domain>,<device_id>,<id>"
```
